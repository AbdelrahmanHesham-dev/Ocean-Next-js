...
function MobileNav() {
  ...
  return (
    <>
      ...
      <figure className={`absolute rounded-md right-2 origin-top top-20 ${isOpen?`scale-y-100 opacity-100 visible`:`scale-y-50 opacity-0 hiding `} w-auto bg-slate-800 p-2 transition-all z-50`}>
